 ...
 */
@Module({
  imports: [CoreModule, AuthModule, AdminModule, CrmModule, OperationsModule, DocumentsModule, FinanceModule, ReferenceModule, AssetsModule, ExportModule, ImportModule],
